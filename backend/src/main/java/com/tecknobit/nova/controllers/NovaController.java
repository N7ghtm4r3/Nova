...
public abstract class NovaController {
    ...
    protected String successResponse() {
        return plainResponse(StandardResponseCode.SUCCESSFUL, RESPONSE_SUCCESSFUL_MESSAGE);
    }
    ...
    protected String successResponse(JSONObject message) {
        return new JSONObject()
                .put(RESPONSE_STATUS_KEY, StandardResponseCode.SUCCESSFUL)
    ...
    protected String failedResponse(String error) {
        return plainResponse(StandardResponseCode.FAILED, error);
    }
