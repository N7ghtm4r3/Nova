...
open class Requester (
     ...
     *
     */
    @RequestPath(path = "/api/v1/users/signUp", method = RequestMethod.POST)
    fun signUp(
        serverSecret: String,
        name: String,
        surname: String,
     ...
     *
     */
    @RequestPath(path = "/api/v1/users/signIn", method = RequestMethod.POST)
    fun signIn(
        email: String,
        password: String
    ) : JSONObject {
     ...
     * @return the result of the request as [JSONObject]
     */
    @RequestPath(path = "/api/v1/users/{id}/changeEmail", method = RequestMethod.PATCH)
    fun changeEmail(
        newEmail: String
    ): JSONObject {
        val payload = Params()
     ...
     * @return the result of the request as [JSONObject]
     */
    @RequestPath(path = "/api/v1/users/{id}/changePassword", method = RequestMethod.PATCH)
    fun changePassword(
        newPassword: String
    ): JSONObject {
        val payload = Params()
     ...
     * @return the result of the request as [JSONObject]
     */
    @RequestPath(path = "/api/v1/users/{id}/changeLanguage", method = RequestMethod.PATCH)
    fun changeLanguage(
        newLanguage: String
    ): JSONObject {
        val payload = Params()
     ...
     * @return the result of the request as [JSONObject]
     */
    @RequestPath(path = "/api/v1/users/{id}", method = RequestMethod.DELETE)
     ...
     * @return the result of the request as [JSONObject]
     */
    @RequestPath(path = "/api/v1/{id}/projects", method = RequestMethod.GET)
     ...
     * @return the result of the request as [JSONObject]
     */
    @RequestPath(path = "/api/v1/{id}/projects/{projectId}", method = RequestMethod.GET)
    fun getProject(
        projectId: String
    ) : JSONObject {
        return execGet(
     ...
     * @return the result of the request as [JSONObject]
     */
    @RequestPath(path = "/api/v1/{id}/projects/{projectId}/addMembers", method = RequestMethod.PUT)
    fun addMembers(
        projectId: String,
        mailingList: String,
        role: Role,
     ...
     *
     */
    @RequestPath(path = "/api/v1/projects/join", method = RequestMethod.POST)
    @Wrapper
    fun joinWithId(
        id: String,
        email: String,
     ...
     *
     */
    @RequestPath(path = "/api/v1/{id}/projects/{projectId}/removeMember", method = RequestMethod.DELETE)
    fun removeMember(
        projectId: String,
        memberId: String
    ) : JSONObject {
     ...
     *
     */
    @RequestPath(path = "/api/v1/{id}/projects/{projectId}/leave", method = RequestMethod.DELETE)
    fun leaveProject(
        projectId: String
    ) : JSONObject {
        return execDelete(
     ...
     *
     */
    @RequestPath(path = "/api/v1/{id}/projects/{projectId}", method = RequestMethod.DELETE)
    fun deleteProject(
        projectId: String
    ) : JSONObject {
        return execDelete(
     ...
     * @return the result of the request as [JSONObject]
     */
    @RequestPath(path = "/api/v1/{id}/projects/{project_id}/releases/addRelease", method = RequestMethod.POST)
    fun addRelease(
        projectId: String,
     ...
     * @return the result of the request as [JSONObject]
     */
    @RequestPath(path = "/api/v1/{id}/projects/{project_id}/releases/{release_id}", method = RequestMethod.GET)
    fun getRelease(
        projectId: String,
        releaseId: String
    ) : JSONObject {
     ...
     * @return the result of the request as [JSONObject]
     */
    @RequestPath(path = "/api/v1/{id}/projects/{project_id}/releases/{release_id}", method = RequestMethod.PATCH)
    fun promoteRelease(
        projectId: String,
        releaseId: String,
        releaseStatus: ReleaseStatus
     ...
     * @return the result of the request as [JSONObject]
     */
    @RequestPath(path = "/api/v1/{id}/projects/{project_id}/releases/{release_id}", method = RequestMethod.DELETE)
    fun deleteRelease(
        projectId: String,
        releaseId: String
    ) : JSONObject {
